...
<Note>
    ...
    Keep in mind that we did not know about all these problems when we started to use these systems. And it is not the fault of the people who created these systems. It is just that we did not know about the dangers of these systems and just deployed them without thinking doing studies or anything. And now we are sadly stuck with them.
