...
<Note>
    ...
    [next]
    we just release these models to the public without rigeriously testing and or without validating them. We or the big coropartions are just boarding everyone on the plan.
    We already start to see the consequences of this but in my opinion as of know the technology is not as entangled in our society as curation ai is.
